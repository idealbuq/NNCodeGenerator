...
import pathlib
import numpy as np
from neural_network import CodeGenerator_V2
...
def main(model_file, function_name, nb_tests, conv_algorithm, output_dir, test_dataset_file=None):
    ...
    net = CodeGenerator_V2(json_file = model_file, test_dataset_file = test_dataset_file, function_name = function_name, nb_tests = nb_tests, conv_algorithm = conv_algorithm)
